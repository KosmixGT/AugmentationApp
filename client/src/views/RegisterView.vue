    ...
    <v-container>
        <div class="centered" style="margin-top: 15%;">
            <div style="font-size: 24px;">
                ...
                <input type="password" style="margin-top: 5px; border: 1px solid; text-indent: 7px;" v-model="password" placeholder="Введите пароль" />
                <p style="margin-top: 10px;"></p>
                <strong><p>Повторите пароль:</p></strong>
                <input type="password" style="margin-top: 5px; border: 1px solid; text-indent: 7px;" v-model="repeatPassword" placeholder="Повторите пароль" />
                <p style="margin-top: 15px;"></p>
                <button v-on:click="addClick" style="margin-top: 15px; border: 1px solid; background-color: aqua; width: 80%;">Регистрация</button>
                <br />
            </div>
        </div>
    </v-container>
